# Django settings for mynet1 project.
...
DATABASE_NAME = '/home/jasonl/svn/mynet/Database/database.db'
		# '/home/jason/Projects/qm_projects/mynet/Database/database.db'  # Or path to database file if using sqlite3.		
